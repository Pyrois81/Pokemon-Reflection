...
; Johto landmarks
	...
	const LANDMARK_DARK_CAVE         ; 06
	const LANDMARK_ROUTE_46          ; 07
	const LANDMARK_ROUTE_45          ; 08
	const LANDMARK_BLACKTHORN_CITY   ; 09
	const LANDMARK_DRAGONS_DEN       ; 0a
	const LANDMARK_ICE_PATH          ; 0b
	const LANDMARK_ROUTE_44          ; 0c
	const LANDMARK_MAHOGANY_TOWN     ; 0d
	const LANDMARK_ROUTE_43          ; 0e
	const LANDMARK_LAKE_OF_RAGE      ; 0f
	const LANDMARK_ROUTE_42          ; 10
	const LANDMARK_MT_MORTAR         ; 11
	const LANDMARK_ECRUTEAK_CITY     ; 12
	const LANDMARK_TIN_TOWER         ; 13
	const LANDMARK_BURNED_TOWER      ; 14
	const LANDMARK_ROUTE_38          ; 15
	const LANDMARK_ROUTE_39          ; 16
	const LANDMARK_OLIVINE_CITY      ; 17
	const LANDMARK_LIGHTHOUSE        ; 18
	const LANDMARK_ROCKET_TOWER      ; 19
	const LANDMARK_ROUTE_40          ; 1a
	const LANDMARK_ROUTE_41          ; 1b
	const LANDMARK_WHIRL_ISLANDS     ; 1c
	const LANDMARK_CIANWOOD_CITY     ; 1d
	const LANDMARK_ROUTE_37          ; 1e
	const LANDMARK_ROUTE_36          ; 1f
	const LANDMARK_NATIONAL_PARK     ; 20
	const LANDMARK_ROUTE_35          ; 21
	const LANDMARK_GOLDENROD_CITY    ; 22
	const LANDMARK_RADIO_TOWER       ; 23
	const LANDMARK_ROUTE_34          ; 24
	const LANDMARK_ILEX_FOREST       ; 25
	const LANDMARK_AZALEA_TOWN       ; 26
	const LANDMARK_SLOWPOKE_WELL     ; 27
	const LANDMARK_ROUTE_33          ; 28
	const LANDMARK_UNION_CAVE        ; 29
	const LANDMARK_ROUTE_32          ; 2a
	const LANDMARK_RUINS_OF_ALPH     ; 2b
	const LANDMARK_VIOLET_CITY       ; 2c
	const LANDMARK_SPROUT_TOWER      ; 2d
