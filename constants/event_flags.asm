...
; TMs
	...
	const EVENT_ELMS_LAB_TM21_FRUSTRATION
...
; Johto story events: Chapter 0
	...
	const EVENT_GOT_TATTERED_HAT_FROM_MR_POKEMON
...
; Chapter 8
	...
	const EVENT_JASMINE_RETURNED_TO_GYM ; untouched
	...
	const EVENT_FAST_SHIP_FIRST_TIME ; untouched
	...
	const EVENT_HEALED_MOOMOO ; untouched
	const EVENT_GOT_TM13_SNORE_FROM_MOOMOO_FARM ; untouched
	const EVENT_TALKED_TO_FARMER_ABOUT_MOOMOO ; untouched
	...
	const EVENT_GOT_TM08_ROCK_SMASH ; untouched
...
; Johto items
	...
	const EVENT_BURNED_TOWER_1F_GOLD_BERRY
