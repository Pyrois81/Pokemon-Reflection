...
; Placeholders
	...
	const EVENT_CIANWOOD_GYM_TM01_DYNAMICPUNCH ; TMs
...
; Chapter 8
	...
	const EVENT_SAW_SUICUNE_AT_CIANWOOD ; Chapter 5
...
; Johto items (placeholders)
	...
	const EVENT_ROUTE_41_TM18_RAIN_DANCE ; TMs
	...
	const EVENT_ROUTE_40_HIDDEN_IRON ; Johto items
	const EVENT_ROUTE_41_HIDDEN_FULL_RESTORE ; Johto items
...
; Johto toggles
	...
	const EVENT_RIVAL_OLIVINE_CITY ; DELETE
	...
	const EVENT_ROUTE_40_MONICA_OF_MONDAY ; DELETE
...
; Kanto people
	...
	const EVENT_ROUTE_40_HIDDEN_MAX_REPEL ; Johto items
	const EVENT_ROCKET_TOWER_ROCKETS_TOGGLE ; Johto toggles
	const EVENT_ROUTE_40_ROCKET_TOWER_GATE_ROCKER_TOGGLE ; Johto toggles
	const EVENT_ROUTE_41_BIG_PEARL ; Johto items
	const EVENT_ROUTE_41_HEAVY_BALL ; Johto items
	const EVENT_ROUTE_41_HIDDEN_WATER_STONE ; Johto items
	const EVENT_CIANWOOD_CITY_EUSINE_TOGGLE ; Johto toggles
	const EVENT_CIANWOOD_CITY_SUICUNE_TOGGLE ; Johto toggles
	const EVENT_CIANWOOD_CITY_CHUCK_TOGGLE ; Johto toggles
	const EVENT_CIANWOOD_CITY_LAPRAS_TOGGLE ; Johto toggles
	const EVENT_HEARD_CHUCKS_PLAN ; Chapter 5
	const EVENT_EUSINES_HOUSE_EUSINE_TOGGLE ; Johto toggles
	const EVENT_MET_EUSINE ; Chapter 4
	const EVENT_MET_PHARMACIST ; Chapter 4
	const EVENT_MET_MANIA ; Chapter 4
	const EVENT_GOT_METAL_COAT_FROM_MANIA ; Chapter 4
	const EVENT_CIANWOOD_GYM_CHUCK_TOGGLE ; Johto toggles
	const EVENT_CIANWOOD_GYM_HIDDEN_HP_UP ; Johto items
	const EVENT_CIANWOOD_GYM_HIDDEN_MAX_POTION ; Johto items
	const EVENT_OLIVINE_LIGHTHOUSE_5F_UNLOCKED_DOORS ; Chapter 4
	const EVENT_BLACKTHORN_CITY_HIDDEN_ELIXIR ; Johto items
	const EVENT_MAHOGANY_TOWN_HIDDEN_EXP_CANDY_M ; Johto items
