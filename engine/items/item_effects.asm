...
FastBallMultiplier:
	; multiply rate by 4 if base speed >= 100
	; thanks to Idain for the optimization!
	ld a, [wEnemyMonBaseStats + 3] ; wEnemyMonBaseStats + 3 = "wEnemyMonBaseSpeed"
	cp 100
	ret c
