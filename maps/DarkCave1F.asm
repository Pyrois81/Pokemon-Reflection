...
DarkCave1FHiddenRareCandy:
	hiddenitem RARE_CANDY, EVENT_DARK_CAVE_1F_HIDDEN_RARE_CANDY
...
DarkCave1F_MapEvents:
	...
	object_event 34,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCave1FGreatBall, EVENT_DARK_CAVE_1F_GREAT_BALL
