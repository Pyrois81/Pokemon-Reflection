...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     PSYDUCK,    MANTINE,    "MANA@@@@@@@", $FF, $FF, LURE_BALL,    29189, "TIM@@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      DUNSPARCE,  PINECO,     "COCO@@@@@@@", $FF, $FF, BRIGHTPOWDER, 53779, "EMY@@@@@@@@", TRADE_GENDER_EITHER
