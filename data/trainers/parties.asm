...
MortyGroup:
	...
	db 29, HAUNTER, HYPNOSIS, CURSE, NIGHTMARE, LICK
	db 28, MISDREAVUS, PERISH_SONG, PSYWAVE, CONFUSE_RAY, GROWL
	db 32, GENGAR, SHADOW_BALL, CURSE, MEAN_LOOK, HIDDEN_POWER
	db 34, MURKROW, FEINT_ATTACK, HAZE, DETECT, FLY
	db 33, MISDREAVUS, PSYBEAM, DESTINY_BOND, PAIN_SPLIT, SHADOW_BALL
	db 35, GENGAR, HYPNOSIS, DREAM_EATER, SHADOW_BALL, NIGHTMARE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 20, SNEASEL,		FEINT_ATTACK, ICY_WIND, QUICK_ATTACK, SCREECH
	db 18, SWINUB,		TACKLE, POWDER_SNOW, ENDURE, MUD_SLAP
	db 19, DELIBIRD,	PRESENT, ICY_WIND, SWIFT, THIEF
	db 22, LAPRAS,		ICY_WIND, WATER_GUN, MIST, BODY_SLAM
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 20, SKARMORY, NO_ITEM, SWAGGER, WHIRLWIND, STEEL_WING, DRILL_PECK
	db 24, FORRETRESS, NO_ITEM, TAKE_DOWN, SELFDESTRUCT, ROLLOUT, PIN_MISSILE
	db 22, STEELIX, NO_ITEM, SANDSTORM, ROCK_THROW, IRON_TAIL, CURSE
	db 25, AMPHAROS, NO_ITEM, ZAP_CANNON, IRON_TAIL, FLASH, SAFEGUARD
	db 27, SCIZOR, METAL_COAT, STEEL_WING, PURSUIT, FOCUS_ENERGY, LIGHT_SCREEN
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 27, PRIMEAPE, NO_ITEM, RAGE, KARATE_CHOP, FURY_SWIPES, FOCUS_ENERGY
	db 25, HITMONLEE, NO_ITEM, JUMP_KICK, MEDITATE, HEADBUTT, LOCK_ON
	db 29, HITMONCHAN, NO_ITEM, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, COMET_PUNCH
	db 28, HITMONTOP, NO_ITEM, FOCUS_ENERGY, ROLLING_KICK, DIG, RAPID_SPIN
	db 30, MACHAMP, NO_ITEM, ICE_PUNCH, FORESIGHT, VITAL_THROW, LOW_KICK
	db 32, POLIWRATH, BLACKBELT_I, WATERFALL, DYNAMICPUNCH, HYPNOSIS, BODY_SLAM
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 11, DRATINI, WRAP, LEER, DOUBLE_TEAM, NO_MOVE
	db 12, KINGDRA, WATER_GUN, TWISTER, ENDURE, SMOKESCREEN
	db 14, DRAGONAIR, THUNDER_WAVE, WRAP, TWISTER, SWAGGER
	db -1 ; end

Rival1Group:
	; RIVAL1_CHERRYGROVE (1)
	db "?@", TRAINERTYPE_MOVES
	db  5, TOGEPI, CHARM, GROWL, METRONOME, NO_MOVE
	db -1 ; end

	; RIVAL1_OLIVINE (2)
	db "?@", TRAINERTYPE_MOVES
	db 26, TOGEPI, METRONOME, SWEET_KISS, MUD_SLAP, REST
	db 24, PHANPY, HEADBUTT, ROLLOUT, FLAIL, DEFENSE_CURL
	db 27, HITMONTOP, ROLLING_KICK, FOCUS_ENERGY, RAPID_SPIN, DETECT
	db -1 ; end
...
ScientistGroup:
	...
	; SCIENTIST (6)
	db "JARROD@", TRAINERTYPE_MOVES
	db 57, SHELLDER, RAIN_DANCE, CLAMP, AURORA_BEAM, SWIFT
	db 59, STARMIE, LIGHT_SCREEN, CONFUSE_RAY, BUBBLEBEAM, PSYCHIC_M
	db 60, OMANYTE, HYDRO_PUMP, BLIZZARD, HIDDEN_POWER, PROTECT
...
SchoolboyGroup:
	...
	; SCHOOLBOY (17) [Chad, 2nd match]
	db "CHAD@", TRAINERTYPE_NORMAL
	db 19, MR__MIME
	db 19, MAGNEMITE
	db -1 ; end

	; SCHOOLBOY (18) [Chad, 3rd match]
	db "CHAD@", TRAINERTYPE_NORMAL
	db 27, MR__MIME
	db 31, MAGNETON
	db -1 ; end
	...
	; SCHOOLBOY (23) [Chad, 4th match]
	db "CHAD@", TRAINERTYPE_NORMAL
	db 30, MR__MIME
	db 34, MAGNETON
	db -1 ; end

	; SCHOOLBOY (24) [Chad, 5th match]
...
CooltrainerMGroup:
	...
	db 15, FLAAFFY, TACKLE, GROWL, THUNDERSHOCK, THUNDER_WAVE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 13, VENONAT,   SUPERSONIC, DISABLE, SCREECH, TACKLE
	db 15, MURKROW,  PECK, PURSUIT, MIRROR_MOVE, QUICK_ATTACK
	db -1 ; end
	...
	db 13, VENONAT,    TACKLE, DISABLE, FORESIGHT, SWAGGER
	db 14, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, FLASH
	db -1 ; end
	...
	db  9, HORSEA,     SMOKESCREEN, FLAIL, WHIRLPOOL, TWISTER
	db  8, MAREEP,     THUNDERSHOCK, GROWL, FLASH, TACKLE
	db  9, BELLSPROUT,     VINE_WHIP, GROWTH, WRAP, LEECH_LIFE
	db -1 ; end
...
BeautyGroup:
	...
	db 19, JIGGLYPUFF, POUND, DISABLE, ATTRACT, REST
	db 20, PHANPY, DEFENSE_CURL, HEADBUTT, ROCK_SMASH, SANDSTORM
	db -1 ; end

	; BEAUTY (17)
	db "OLIVIA@", TRAINERTYPE_MOVES
	db 22, BUTTERFREE, CONFUSION, POISONPOWDER, SWEET_SCENT, WHIRLWIND
	db -1 ; end
	
	; BEAUTY (18)
	db "MELISSA@", TRAINERTYPE_MOVES
	db 23, PINECO, PIN_MISSILE, TAKE_DOWN, LIGHT_SCREEN, SWEET_SCENT
	db 22, CORSOLA, BUBBLE, RECOVER, ROCK_SLIDE, DOUBLE_TEAM
	db -1 ; end
...
PokemaniacGroup:
	...
	db 40, PORYGON2,    RECOVER, PSYCHIC_M, CONVERSION2, TRI_ATTACK
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 50, CHANSEY,    HYPER_BEAM, ATTRACT, EGG_BOMB, SOFTBOILED
	db -1 ; end
...
FisherGroup:
	...
	db 13, MAGIKARP,   BUBBLE, FLAIL, TACKLE, NO_MOVE
	db 14, WOOPER,     WATER_GUN, LEER, SLAM, NO_MOVE
	db -1 ; end
...
SwimmerMGroup:
	...
	db 24, TOTODILE, BITE, WATER_GUN, HEADBUTT, LEER
	db 25, POLIWHIRL, DOUBLESLAP, WATER_GUN, ICE_PUNCH, THIEF
	db -1 ; end
...
SwimmerFGroup:
	...
	db 25, AZUMARILL, BUBBLEBEAM, DEFENSE_CURL, WHIRLPOOL, ICY_WIND
	db -1 ; end
	...
	db 26, SLOWKING, CONFUSION, CURSE, SWIFT, HIDDEN_POWER
	db -1 ; end
...
SuperNerdGroup:
	...
	db 22, MAGNEMITE, THUNDERSHOCK, SWIFT, HIDDEN_POWER, SUPERSONIC
	db 21, GEODUDE, ROCK_THROW, MAGNITUDE, TACKLE, DEFENSE_CURL
	db -1 ; end
...
GuitaristGroup:
	...
	; GUITARIST (3)
	db "RIDLEY@", TRAINERTYPE_MOVES
	db 26, MAGNETON, THUNDERSHOCK, LOCK_ON, SONICBOOM, SUPERSONIC
	db -1 ; end
...
HikerGroup:
	...
	db 50, SUDOWOODO, ROCK_SLIDE, SLAM, FIRE_PUNCH, DIG
	db 50, DONPHAN, EARTHQUAKE, DOUBLE_EDGE, HORN_ATTACK, SANDSTORM
	db 50, STEELIX, CRUNCH, DRAGONBREATH, EARTHQUAKE, CURSE
	db -1 ; end
	...
	db 65, STEELIX, EARTHQUAKE, BODY_SLAM, CRUNCH, EXPLOSION
	db 60, PILOSWINE, MAGNITUDE, BLIZZARD, MUD_SLAP, ANCIENTPOWER
	db 63, RHYDON, EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, ZAP_CANNON
	db 66, POLIWRATH, WATERFALL, SUBMISSION, FISSURE, MEGA_PUNCH
	db -1 ; end
...
BlackbeltGroup:
	...
	db 24, TYROGUE, MACH_PUNCH, ROCK_SLIDE, ROCK_SMASH, TACKLE
	db 25, MACHOP,  LEER, MEDITATE, LOW_KICK, SEISMIC_TOSS
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 28, HITMONCHAN, COMET_PUNCH, THUNDERPUNCH, AGILITY, PURSUIT
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 26, POLIWHIRL, WATERFALL, ICE_PUNCH, STRENGTH, HYPNOSIS
	db 27, HERACROSS, FURY_CUTTER, HORN_ATTACK, ATTRACT, COUNTER
	db -1 ; end
	...
	db 24, MANKEY, KARATE_CHOP, SCRATCH, FURY_SWIPES, THIEF
	db 29, PRIMEAPE, RAGE, FOCUS_ENERGY, DYNAMICPUNCH, FIRE_PUNCH
	db -1 ; end
...
PsychicGroup:
	...
	db 19, NATU,   PECK, NIGHT_SHADE, LIGHT_SCREEN, PSYCH_UP
	db 22, WOBBUFFET, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db -1 ; end
...
PicnickerGroup:
	...
	; PICNICKER (16) [Tiffany, 2nd match]
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 24, GLOOM,   ACID, CUT, SYNTHESIS, HIDDEN_POWER
	db 22, CLEFAIRY, SING, MINIMIZE, METRONOME, PRESENT
	db -1 ; end

	; PICNICKER (17) [Tiffany, 3rd match]
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 35, GLOOM,   SLUDGE_BOMB, SWEET_SCENT, SLEEP_POWDER, GIGA_DRAIN
	db 37, FARFETCH_D, FLY, STEEL_WING, SLASH, THIEF
	db 30, CLEFAIRY, METRONOME, ICE_BEAM, PRESENT, SWEET_KISS
	db -1 ; end
	...
	; PICNICKER (20) [Tiffany, 1st match]
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 13, ODDISH,   POISONPOWDER, CUT, SYNTHESIS, HIDDEN_POWER
	db 16, CLEFAIRY, SING, DOUBLESLAP, RETURN, CHARM
	db -1 ; end
	...
	; PICNICKER (26) [Tiffany, 4th match]
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 45, CLEFAIRY, AMNESIA, MINIMIZE, ICE_BEAM, PSYCHIC_M
	db 48, VILEPLUME,   SLUDGE_BOMB, SOLARBEAM, SLEEP_POWDER, MOONLIGHT
	db 47, FARFETCH_D, FLY, STEEL_WING, SLASH, SWORDS_DANCE
	db -1 ; end
...
CamperGroup:
	...
	db 41, CHARMELEON, SLASH, SMOKESCREEN, SWIFT, FLAMETHROWER  
	db 42, CROBAT, MEAN_LOOK, WING_ATTACK, TOXIC, CONFUSE_RAY
	db 42, SLOWBRO, ICE_BEAM, PSYCHIC_M, DEFENSE_CURL, FUTURE_SIGHT
	db -1 ; end
	...
	db 18, VAPOREON, ATTRACT, RETURN, ENDURE, WATERFALL
	db 18, VAPOREON, DOUBLE_TEAM, BITE, ROAR, HYDRO_PUMP
	db -1 ; end
...
KimonoGirlGroup:
	; KIMONO_GIRL (1)
	db "HONOKO@", TRAINERTYPE_MOVES
	db 20, FLAREON, HIDDEN_POWER, SUNNY_DAY, MUD_SLAP, HEADBUTT
	db -1 ; end

	; KIMONO_GIRL (2)
	db "REIKO@", TRAINERTYPE_MOVES
	db 20, ESPEON, CONFUSION, SAND_ATTACK, REST, REFLECT
	db -1 ; end

	; KIMONO_GIRL (3)
	db "ANJU@", TRAINERTYPE_MOVES
	db 20, UMBREON, PURSUIT, PSYCH_UP, DOUBLE_TEAM, MOONLIGHT
	db -1 ; end

	; KIMONO_GIRL (4)
	db "MINATO@", TRAINERTYPE_MOVES
	db 20, VAPOREON, WATER_GUN, RAIN_DANCE, WHIRLPOOL, ICY_WIND
	db -1 ; end

	; KIMONO_GIRL (5)
	db "AZUMA@", TRAINERTYPE_MOVES
	db 20, JOLTEON, THUNDERSHOCK, THUNDER_WAVE, SWIFT, ROAR
	db -1 ; end
...
MysticalmanGroup:
	...
	db 32, HYPNO,    DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
	db 31, MISDREAVUS,    CONFUSE_RAY, PSYBEAM, MEAN_LOOK, CURSE
	db 30, ELECTRODE,  HIDDEN_POWER, DOUBLE_TEAM, SPARK, SIGNAL_BEAM
	db 33, KANGASKHAN, MEGA_PUNCH, BITE, IRON_TAIL, ROCK_SLIDE
	db -1 ; end
