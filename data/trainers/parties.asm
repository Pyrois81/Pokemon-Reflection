...
ClairGroup:
	...
	db 12, DRATINI, WRAP, LEER, DOUBLE_TEAM, NO_MOVE
	db 13, KINGDRA, WATER_GUN, DRAGONBREATH, ENDURE, SMOKESCREEN
	db 15, DRAGONAIR, THUNDER_WAVE, WRAP, TWISTER, SWAGGER
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 10, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db  9, MAREEP,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 11, BELLSPROUT,     SWIFT, LEER, WATERFALL, TWISTER
	db -1 ; end
