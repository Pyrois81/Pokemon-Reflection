...
PryceGroup:
	...
	db 17, SNEASEL,		FAINT_ATTACK, ICY_WIND, QUICK_ATTACK, SCREECH
	db 15, SWINUB,		TACKLE, POWDER_SNOW, ENDURE, MUD_SLAP
	db 16, DELIBIRD,	PRESENT, ICY_WIND, SWIFT, THIEF
	db 18, LAPRAS,		ICY_WIND, WATER_GUN, MIST, BODY_SLAM
	db -1 ; end
...
ClairGroup:
	...
	db 10, DRATINI, WRAP, LEER, DOUBLE_TEAM, NO_MOVE
	db 11, KINGDRA, WATER_GUN, TWISTER, ENDURE, SMOKESCREEN
	db 12, DRAGONAIR, THUNDER_WAVE, WRAP, TWISTER, SWAGGER
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 13, MURKROW,  PECK, PURSUIT, MIRROR_MOVE, QUICK_ATTACK
	db -1 ; end
...
PicnickerGroup:
	...
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 14, ODDISH,   POISONPOWDER, CUT, SYNTHESIS, HIDDEN_POWER
	db 13, CLEFAIRY, SING, DOUBLESLAP, RETURN, CHARM
	db -1 ; end
