...
MortyGroup:
	...
	db 34, MURKROW, FAINT_ATTACK, HAZE, DETECT, FLY
...
PryceGroup:
	...
	db 18, SNEASEL,		FAINT_ATTACK, ICY_WIND, QUICK_ATTACK, SCREECH
	db 16, SWINUB,		TACKLE, POWDER_SNOW, ENDURE, MUD_SLAP
	db 17, DELIBIRD,	PRESENT, ICY_WIND, SWIFT, THIEF
	db 20, LAPRAS,		ICY_WIND, WATER_GUN, MIST, BODY_SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 12, VENONAT,   SUPERSONIC, DISABLE, SCREECH, TACKLE
	db 14, MURKROW,  PECK, PURSUIT, MIRROR_MOVE, QUICK_ATTACK
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     SYNTHESIS, LEER, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   SYNTHESIS, LEER, TACKLE, STUN_SPORE
	db -1 ; end
...
FisherGroup:
	...
	db 12, MAGIKARP,   BUBBLE, FLAIL, TACKLE, NO_MOVE
	db 11, WOOPER,     WATER_GUN, LEER, SLAM, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 12, ODDISH,   POISONPOWDER, CUT, SYNTHESIS, HIDDEN_POWER
	db 15, CLEFAIRY, SING, DOUBLESLAP, RETURN, CHARM
	db -1 ; end
...
KimonoGirlGroup:
	...
	; KIMONO_GIRL (3)
	db "ANJU@", TRAINERTYPE_NORMAL
	db 18, UMBREON
	db -1 ; end

	; KIMONO_GIRL (4)
	db "MINATO@", TRAINERTYPE_NORMAL
	db 18, VAPOREON
	db -1 ; end

	; KIMONO_GIRL (5)
	db "AZUMA@", TRAINERTYPE_NORMAL
	db 18, JOLTEON
	db -1 ; end
