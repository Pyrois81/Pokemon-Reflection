	...
	tilecoll WALL, HEADBUTT_TREE, WALL, WALL ; 86
	tilecoll FLOOR, FLOOR, WALL, FLOOR ; 87
	tilecoll FLOOR, FLOOR, FLOOR, WALL ; 88
	tilecoll WHIRLPOOL, WHIRLPOOL, WHIRLPOOL, WHIRLPOOL ; 89
	...
	tilecoll FLOOR, HEADBUTT_TREE, HEADBUTT_TREE, FLOOR ; 97
	tilecoll HEADBUTT_TREE, FLOOR, FLOOR, HEADBUTT_TREE ; 98
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; 99
	tilecoll WALL, WALL, TALL_GRASS, TALL_GRASS ; 9a
	tilecoll TALL_GRASS, WALL, TALL_GRASS, WALL ; 9b
	tilecoll TALL_GRASS, TALL_GRASS, WALL, WALL ; 9c
	tilecoll WALL, TALL_GRASS, WALL, TALL_GRASS ; 9d
	tilecoll WALL, WALL, WALL, TALL_GRASS ; 9e
	tilecoll WALL, WALL, TALL_GRASS, WALL ; 9f
	tilecoll WALL, TALL_GRASS, WALL, WALL ; a0
	tilecoll TALL_GRASS, WALL, WALL, WALL ; a1
